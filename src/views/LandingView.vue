    ...
    <section class="min-h-[calc(100vh*0.80)] w-full flex justify-center mb-52" id="landing-page">
        <div class="flex items-center space-x-0 space-y-7 md:space-y-0 md:space-x-7 flex-col md:flex-row m-auto">
            ...
            <div class="flex flex-col space-y-2">
                ...
                <p :class="['text-sm lg:text-base text-slate-500 dark:text-slate-300 transition-all motion-reduce:transition-none duration-500 delay-[600ms]', showTransition ? 'translate-y-0 opacity-1' : '-translate-y-4 opacity-0']" v-html="content.message"></p>
            </div>
        </div>
    </section>
</template>
